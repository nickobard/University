...
$tasks = [
    [
        ...
        'name' => 'Parking machines',
        'subtasks' => [
            [
                'name' => 'ParkingMachineInputTest',
                'testsuite' => 'FinalTask\Tests\ParkingMachines\ParkingMachineInputTest',
                'points' => 2
            ], [
                'name' => 'ParkingMachineOutputTest',
                'testsuite' => 'FinalTask\Tests\ParkingMachines\ParkingMachineOutputTest',
                'points' => 8
            ]
        ]
    ], [

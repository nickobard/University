...
const SOURCE_CLASSES_DIR = 'classes';
const SOURCE_FILES_EXTENSION = '.php';

spl_autoload_register(function (string $className) {
    require_once __DIR__ . DIRECTORY_SEPARATOR . SOURCE_CLASSES_DIR . DIRECTORY_SEPARATOR . $className . SOURCE_FILES_EXTENSION;
});
